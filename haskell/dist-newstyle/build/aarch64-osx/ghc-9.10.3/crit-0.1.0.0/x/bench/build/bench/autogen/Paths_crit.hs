...
-- at runtime using the environment variable crit_bindir.
...
-- environment variable crit_libdir.
...
-- using the environment variable crit_dynlibdir.
...
-- runtime using the environment variable crit_datadir.
...
-- using the environment variable crit_sysconfdir.
...
libdir     = "/Users/drakezhard/.cabal/lib/aarch64-osx-ghc-9.10.3-fe9c/crit-0.1.0.0-inplace-bench"
