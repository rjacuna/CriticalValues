...
-- at runtime using the environment variable Flint2_bindir.
...
-- environment variable Flint2_libdir.
...
-- using the environment variable Flint2_dynlibdir.
...
-- runtime using the environment variable Flint2_datadir.
...
-- using the environment variable Flint2_sysconfdir.
...
libdir     = "/Users/drakezhard/.cabal/lib/aarch64-osx-ghc-9.10.3-fe9c/Flint2-0.1.0.5-inplace"
dynlibdir  = "/Users/drakezhard/.cabal/lib/aarch64-osx-ghc-9.10.3-fe9c"
datadir    = "/Users/drakezhard/.cabal/share/aarch64-osx-ghc-9.10.3-fe9c/Flint2-0.1.0.5"
libexecdir = "/Users/drakezhard/.cabal/libexec/aarch64-osx-ghc-9.10.3-fe9c/Flint2-0.1.0.5"
sysconfdir = "/Users/drakezhard/.cabal/etc"

getBinDir     = catchIO (getEnv "Flint2_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "Flint2_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "Flint2_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "Flint2_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "Flint2_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "Flint2_sysconfdir") (\_ -> return sysconfdir)
