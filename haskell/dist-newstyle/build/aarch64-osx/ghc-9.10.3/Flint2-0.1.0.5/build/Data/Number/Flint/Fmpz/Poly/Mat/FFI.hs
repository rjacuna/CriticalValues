...
instance Storable CFmpzPolyMat where
  {-# INLINE sizeOf #-}
  sizeOf _ = (32)
{-# LINE 124 "src/Data/Number/Flint/Fmpz/Poly/Mat/FFI.hsc" #-}
  {-# INLINE alignment #-}
  alignment _ = 8
{-# LINE 126 "src/Data/Number/Flint/Fmpz/Poly/Mat/FFI.hsc" #-}
  peek ptr = CFmpzPolyMat
    <$> (\hsc_ptr -> peekByteOff hsc_ptr 0) ptr
{-# LINE 128 "src/Data/Number/Flint/Fmpz/Poly/Mat/FFI.hsc" #-}
