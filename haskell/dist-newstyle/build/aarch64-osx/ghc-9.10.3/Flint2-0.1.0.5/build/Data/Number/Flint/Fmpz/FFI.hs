{-# LINE 1 "src/Data/Number/Flint/Fmpz/FFI.hsc" #-}
{-|
...
instance Storable CFmpz where
  {-# INLINE sizeOf #-}
  sizeOf _ = (8)
{-# LINE 317 "src/Data/Number/Flint/Fmpz/FFI.hsc" #-}
  {-# INLINE alignment #-}
  alignment _ = 8
{-# LINE 319 "src/Data/Number/Flint/Fmpz/FFI.hsc" #-}
...
instance Storable CFmpzComb where
  {-# INLINE sizeOf #-}
  sizeOf _ = (288)
{-# LINE 337 "src/Data/Number/Flint/Fmpz/FFI.hsc" #-}
  {-# INLINE alignment #-}
  alignment _ = 8
{-# LINE 339 "src/Data/Number/Flint/Fmpz/FFI.hsc" #-}
...
instance Storable CFmpzCombTemp where
  {-# INLINE sizeOf #-}
  sizeOf _ = (32)
{-# LINE 351 "src/Data/Number/Flint/Fmpz/FFI.hsc" #-}
  {-# INLINE alignment #-}
  alignment _ = 8
{-# LINE 353 "src/Data/Number/Flint/Fmpz/FFI.hsc" #-}
...
instance Storable CFmpzMultiCRT where
  {-# INLINE sizeOf #-}
  sizeOf _ = (112)
{-# LINE 365 "src/Data/Number/Flint/Fmpz/FFI.hsc" #-}
  {-# INLINE alignment #-}
  alignment _ = 8
{-# LINE 367 "src/Data/Number/Flint/Fmpz/FFI.hsc" #-}
...
instance Storable CFmpzFactor where
  {-# INLINE sizeOf #-}
  sizeOf _ = (40)
{-# LINE 379 "src/Data/Number/Flint/Fmpz/FFI.hsc" #-}
  {-# INLINE alignment #-}
  alignment _ = 8
{-# LINE 381 "src/Data/Number/Flint/Fmpz/FFI.hsc" #-}
  peek ptr = CFmpzFactor
    <$> (\hsc_ptr -> peekByteOff hsc_ptr 0) ptr
{-# LINE 383 "src/Data/Number/Flint/Fmpz/FFI.hsc" #-}
    <*> (\hsc_ptr -> peekByteOff hsc_ptr 8) ptr
{-# LINE 384 "src/Data/Number/Flint/Fmpz/FFI.hsc" #-}
    <*> (\hsc_ptr -> peekByteOff hsc_ptr 16) ptr
{-# LINE 385 "src/Data/Number/Flint/Fmpz/FFI.hsc" #-}
    <*> (\hsc_ptr -> peekByteOff hsc_ptr 24) ptr
{-# LINE 386 "src/Data/Number/Flint/Fmpz/FFI.hsc" #-}
    <*> (\hsc_ptr -> peekByteOff hsc_ptr 32) ptr
{-# LINE 387 "src/Data/Number/Flint/Fmpz/FFI.hsc" #-}
