{-# LINE 1 "src/Data/Number/Flint/Acb/Dirichlet/FFI.hsc" #-}
{-|
...
instance Storable CDirichletRoots where
  sizeOf    _ = (144)
{-# LINE 157 "src/Data/Number/Flint/Acb/Dirichlet/FFI.hsc" #-}
  alignment _ = 8
{-# LINE 158 "src/Data/Number/Flint/Acb/Dirichlet/FFI.hsc" #-}
  peek = undefined
  poke = undefined
...
instance Storable CDirichletHurwitzPrecomp where
  sizeOf _    = (152)
{-# LINE 404 "src/Data/Number/Flint/Acb/Dirichlet/FFI.hsc" #-}
  alignment _ = 8
{-# LINE 405 "src/Data/Number/Flint/Acb/Dirichlet/FFI.hsc" #-}
  peek = undefined
  poke = undefined
