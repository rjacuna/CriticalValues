{-# LINE 1 "src/Data/Number/Flint/Acb/DFT/FFI.hsc" #-}
{-|
...
instance Storable CAcbDftPre where
  sizeOf _ = (432)
{-# LINE 149 "src/Data/Number/Flint/Acb/DFT/FFI.hsc" #-}
  alignment _ = 8
{-# LINE 150 "src/Data/Number/Flint/Acb/DFT/FFI.hsc" #-}
  peek = undefined
  poke = undefined
...
instance Storable CAcbDftCrt where
  sizeOf _ = (416)
{-# LINE 396 "src/Data/Number/Flint/Acb/DFT/FFI.hsc" #-}
  alignment _ = 8
{-# LINE 397 "src/Data/Number/Flint/Acb/DFT/FFI.hsc" #-}
  peek = undefined
  poke = undefined
