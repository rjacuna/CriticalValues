{-# LINE 1 "src/Data/Number/Flint/Fq/Mat/FFI.hsc" #-}
{-|
...
instance Storable CFqMat where
  {-# INLINE sizeOf #-}
  sizeOf _ = (32)
{-# LINE 137 "src/Data/Number/Flint/Fq/Mat/FFI.hsc" #-}
  {-# INLINE alignment #-}
  alignment _ = 8
{-# LINE 139 "src/Data/Number/Flint/Fq/Mat/FFI.hsc" #-}
  peek ptr = CFqMat
    <$> (\hsc_ptr -> peekByteOff hsc_ptr 0) ptr
{-# LINE 141 "src/Data/Number/Flint/Fq/Mat/FFI.hsc" #-}
    <*> (\hsc_ptr -> peekByteOff hsc_ptr 8) ptr
{-# LINE 142 "src/Data/Number/Flint/Fq/Mat/FFI.hsc" #-}
    <*> (\hsc_ptr -> peekByteOff hsc_ptr 16) ptr
{-# LINE 143 "src/Data/Number/Flint/Fq/Mat/FFI.hsc" #-}
    <*> (\hsc_ptr -> peekByteOff hsc_ptr 24) ptr
{-# LINE 144 "src/Data/Number/Flint/Fq/Mat/FFI.hsc" #-}
  poke = undefined
