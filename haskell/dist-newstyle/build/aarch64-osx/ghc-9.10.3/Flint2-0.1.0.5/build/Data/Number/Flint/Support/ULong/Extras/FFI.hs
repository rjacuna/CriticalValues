{-# OPTIONS_GHC -optc-DULONG_EXTRAS_INLINES_C #-}
{-# LINE 1 "src/Data/Number/Flint/Support/ULong/Extras/FFI.hsc" #-}
{-|
...
instance Storable CNFactor where
  {-# INLINE sizeOf #-}
  sizeOf _ = (184)
{-# LINE 181 "src/Data/Number/Flint/Support/ULong/Extras/FFI.hsc" #-}
  {-# INLINE alignment #-}
  alignment _ = 8
{-# LINE 183 "src/Data/Number/Flint/Support/ULong/Extras/FFI.hsc" #-}
  peek ptr = do
    num <- (\hsc_ptr -> peekByteOff hsc_ptr 0) ptr
{-# LINE 185 "src/Data/Number/Flint/Support/ULong/Extras/FFI.hsc" #-}
    exp <- return $ castPtr $ ptr `plusPtr` (sizeOf (undefined :: CInt))
    p   <- return $ castPtr $ ptr `plusPtr` (sizeOf (undefined :: CInt) * (1 + 15))
{-# LINE 187 "src/Data/Number/Flint/Support/ULong/Extras/FFI.hsc" #-}
...
instance Storable CNPrimes where
  {-# INLINE sizeOf #-}
  sizeOf _ = (64)
{-# LINE 208 "src/Data/Number/Flint/Support/ULong/Extras/FFI.hsc" #-}
  {-# INLINE alignment #-}
  alignment _ = 8
{-# LINE 210 "src/Data/Number/Flint/Support/ULong/Extras/FFI.hsc" #-}
  peek = undefined
  poke = undefined
...
instance Storable CNEcm where
  {-# INLINE sizeOf #-}
  sizeOf _ = (64)
{-# LINE 235 "src/Data/Number/Flint/Support/ULong/Extras/FFI.hsc" #-}
  {-# INLINE alignment #-}
  alignment _ = 8
{-# LINE 237 "src/Data/Number/Flint/Support/ULong/Extras/FFI.hsc" #-}
  peek = undefined
  poke = undefined
