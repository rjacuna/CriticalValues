{-# LINE 1 "src/Data/Number/Flint/Fmpz/Mod/Poly/FFI.hsc" #-}
{-|
...
instance Storable CFmpzModPoly where
  {-# INLINE sizeOf #-}
  sizeOf _ = (24)
{-# LINE 360 "src/Data/Number/Flint/Fmpz/Mod/Poly/FFI.hsc" #-}
  {-# INLINE alignment #-}
  alignment _ = 8
{-# LINE 362 "src/Data/Number/Flint/Fmpz/Mod/Poly/FFI.hsc" #-}
  peek ptr = return CFmpzModPoly 
    `ap` (\hsc_ptr -> peekByteOff hsc_ptr 0) ptr
{-# LINE 364 "src/Data/Number/Flint/Fmpz/Mod/Poly/FFI.hsc" #-}
    `ap` (\hsc_ptr -> peekByteOff hsc_ptr 8) ptr
{-# LINE 365 "src/Data/Number/Flint/Fmpz/Mod/Poly/FFI.hsc" #-}
    `ap` (\hsc_ptr -> peekByteOff hsc_ptr 16) ptr
{-# LINE 366 "src/Data/Number/Flint/Fmpz/Mod/Poly/FFI.hsc" #-}
...
instance Storable CFmpzModPolyRadix where
  {-# INLINE sizeOf #-}
  sizeOf _ = (56)
{-# LINE 377 "src/Data/Number/Flint/Fmpz/Mod/Poly/FFI.hsc" #-}
  {-# INLINE alignment #-}
  alignment _ = 8
{-# LINE 379 "src/Data/Number/Flint/Fmpz/Mod/Poly/FFI.hsc" #-}
