{-# LINE 1 "src/Data/Number/Flint/Calcium/Ca/FFI.hsc" #-}
{-| 
...
instance Storable CCa where
  {-# INLINE sizeOf #-}
  sizeOf _ = (40)
{-# LINE 315 "src/Data/Number/Flint/Calcium/Ca/FFI.hsc" #-}
  {-# INLINE alignment #-}
  alignment _ = 8
{-# LINE 317 "src/Data/Number/Flint/Calcium/Ca/FFI.hsc" #-}
...
instance Storable CCaFactor where
  {-# INLINE sizeOf #-}
  sizeOf _ = (32)
{-# LINE 341 "src/Data/Number/Flint/Calcium/Ca/FFI.hsc" #-}
  {-# INLINE alignment #-}
  alignment _ = 8
{-# LINE 343 "src/Data/Number/Flint/Calcium/Ca/FFI.hsc" #-}
...
instance Storable CCaCtx where
  {-# INLINE sizeOf #-}
  sizeOf _ = (120)
{-# LINE 369 "src/Data/Number/Flint/Calcium/Ca/FFI.hsc" #-}
  {-# INLINE alignment #-}
  alignment _ = 8
{-# LINE 371 "src/Data/Number/Flint/Calcium/Ca/FFI.hsc" #-}
...
ca_print_n       =  1
{-# LINE 482 "src/Data/Number/Flint/Calcium/Ca/FFI.hsc" #-}
-- | /ca_print_digits/
--
...
ca_print_digits  = 16
{-# LINE 488 "src/Data/Number/Flint/Calcium/Ca/FFI.hsc" #-}
-- | /ca_print_repr/
--
...
ca_print_repr    = 2
{-# LINE 499 "src/Data/Number/Flint/Calcium/Ca/FFI.hsc" #-}
-- | /ca_print_field/
--
...
{-# LINE 1889 "src/Data/Number/Flint/Calcium/Ca/FFI.hsc" #-}
-- | /ca_factor_poly_content/
-- 
-- Only extract the rational content.
-- 
ca_factor_poly_content = 64
{-# LINE 1894 "src/Data/Number/Flint/Calcium/Ca/FFI.hsc" #-}
-- | /ca_factor_poly_sqf/
-- 
...
{-# LINE 1900 "src/Data/Number/Flint/Calcium/Ca/FFI.hsc" #-}
-- | /ca_factor_poly_full/
-- 
...
{-# LINE 1911 "src/Data/Number/Flint/Calcium/Ca/FFI.hsc" #-}
-- | /ca_factor_zz_none/
-- 
-- No integer factorization at all.
-- 
ca_factor_zz_none = 0
{-# LINE 1916 "src/Data/Number/Flint/Calcium/Ca/FFI.hsc" #-}
-- | /ca_factor_zz_smooth/
-- 
...
{-# LINE 1923 "src/Data/Number/Flint/Calcium/Ca/FFI.hsc" #-}
-- | /ca_factor_zz_full/
-- 
...
ca_factor_zz_full = 4
{-# LINE 1928 "src/Data/Number/Flint/Calcium/Ca/FFI.hsc" #-}
...
-- 
ca_opt_verbose = 0
{-# LINE 1959 "src/Data/Number/Flint/Calcium/Ca/FFI.hsc" #-}
-- | /ca_opt_print_flags/
-- 
...
{-# LINE 1965 "src/Data/Number/Flint/Calcium/Ca/FFI.hsc" #-}
-- | /ca_opt_mpoly_ord/
-- 
...
-- 
ca_opt_mpoly_ord = 2
{-# LINE 1973 "src/Data/Number/Flint/Calcium/Ca/FFI.hsc" #-}
-- | /ca_opt_prec_limit/
-- 
...
-- 
ca_opt_prec_limit = 3
{-# LINE 1984 "src/Data/Number/Flint/Calcium/Ca/FFI.hsc" #-}
-- | /ca_opt_qqbar_deg_limit/
-- 
...
{-# LINE 1992 "src/Data/Number/Flint/Calcium/Ca/FFI.hsc" #-}
-- | /ca_opt_low_prec/
-- 
...
-- 
ca_opt_pow_limit = 8
{-# LINE 2015 "src/Data/Number/Flint/Calcium/Ca/FFI.hsc" #-}
-- | /ca_opt_use_groebner/
-- 
...
{-# LINE 2023 "src/Data/Number/Flint/Calcium/Ca/FFI.hsc" #-}
-- | /ca_opt_groebner_length_limit/
-- 
...
{-# LINE 2029 "src/Data/Number/Flint/Calcium/Ca/FFI.hsc" #-}
-- | /ca_opt_groebner_poly_length_limit/
-- 
...
{-# LINE 2035 "src/Data/Number/Flint/Calcium/Ca/FFI.hsc" #-}
-- | /ca_opt_groebner_poly_bits_limit/
-- 
...
{-# LINE 2042 "src/Data/Number/Flint/Calcium/Ca/FFI.hsc" #-}
-- | /ca_opt_vieta_limit/
-- 
...
{-# LINE 2052 "src/Data/Number/Flint/Calcium/Ca/FFI.hsc" #-}
-- | /ca_opt_trig_form/
-- 
...
ca_opt_trig_form = 14
{-# LINE 2066 "src/Data/Number/Flint/Calcium/Ca/FFI.hsc" #-}
-- | /ca_trig_direct/
-- 
-- Use the direct functions (with some exceptions).
-- 
ca_trig_direct = 0
{-# LINE 2071 "src/Data/Number/Flint/Calcium/Ca/FFI.hsc" #-}
-- | /ca_trig_exponential/
-- 
-- Use complex exponentials.
-- 
ca_trig_exponential = 1
{-# LINE 2076 "src/Data/Number/Flint/Calcium/Ca/FFI.hsc" #-}
-- | /ca_trig_sine_cosine/
-- 
-- Use sines and cosines.
-- 
ca_trig_sine_cosine = 2
{-# LINE 2081 "src/Data/Number/Flint/Calcium/Ca/FFI.hsc" #-}
-- | /ca_trig_tangent/
-- 
-- Use tangents.
-- 
ca_trig_tangent = 3
{-# LINE 2086 "src/Data/Number/Flint/Calcium/Ca/FFI.hsc" #-}
