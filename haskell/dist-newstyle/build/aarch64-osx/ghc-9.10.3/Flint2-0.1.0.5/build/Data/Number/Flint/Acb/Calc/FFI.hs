{-# LINE 1 "src/Data/Number/Flint/Acb/Calc/FFI.hsc" #-}
{-|
...
instance Storable CAcbCalcIntegrateOpt where
  sizeOf    _ = (32)
{-# LINE 61 "src/Data/Number/Flint/Acb/Calc/FFI.hsc" #-}
  alignment _ = 8
{-# LINE 62 "src/Data/Number/Flint/Acb/Calc/FFI.hsc" #-}
  peek ptr = CAcbCalcIntegrateOpt
    <$> (\hsc_ptr -> peekByteOff hsc_ptr 0) ptr
{-# LINE 64 "src/Data/Number/Flint/Acb/Calc/FFI.hsc" #-}
    <*> (\hsc_ptr -> peekByteOff hsc_ptr 8) ptr
{-# LINE 65 "src/Data/Number/Flint/Acb/Calc/FFI.hsc" #-}
    <*> (\hsc_ptr -> peekByteOff hsc_ptr 16) ptr
{-# LINE 66 "src/Data/Number/Flint/Acb/Calc/FFI.hsc" #-}
    <*> (\hsc_ptr -> peekByteOff hsc_ptr 24) ptr
{-# LINE 67 "src/Data/Number/Flint/Acb/Calc/FFI.hsc" #-}
    <*> (\hsc_ptr -> peekByteOff hsc_ptr 28) ptr
{-# LINE 68 "src/Data/Number/Flint/Acb/Calc/FFI.hsc" #-}
  poke ptr (CAcbCalcIntegrateOpt deg eval depth heap verbose) = do
    ((\hsc_ptr -> pokeByteOff hsc_ptr 0)) ptr deg
{-# LINE 70 "src/Data/Number/Flint/Acb/Calc/FFI.hsc" #-}
    ((\hsc_ptr -> pokeByteOff hsc_ptr 8)) ptr eval
{-# LINE 71 "src/Data/Number/Flint/Acb/Calc/FFI.hsc" #-}
    ((\hsc_ptr -> pokeByteOff hsc_ptr 16)) ptr depth
{-# LINE 72 "src/Data/Number/Flint/Acb/Calc/FFI.hsc" #-}
    ((\hsc_ptr -> pokeByteOff hsc_ptr 24)) ptr heap
{-# LINE 73 "src/Data/Number/Flint/Acb/Calc/FFI.hsc" #-}
    ((\hsc_ptr -> pokeByteOff hsc_ptr 28)) ptr verbose
{-# LINE 74 "src/Data/Number/Flint/Acb/Calc/FFI.hsc" #-}
