{-# LINE 1 "src/Data/Number/Flint/Fmpq/Mat/FFI.hsc" #-}
{-|
...
instance Storable CFmpqMat where
  {-# INLINE sizeOf #-}
  sizeOf _ = (32)
{-# LINE 153 "src/Data/Number/Flint/Fmpq/Mat/FFI.hsc" #-}
  {-# INLINE alignment #-}
  alignment _ = 8
{-# LINE 155 "src/Data/Number/Flint/Fmpq/Mat/FFI.hsc" #-}
  peek ptr = CFmpqMat
    <$> (\hsc_ptr -> peekByteOff hsc_ptr 0) ptr
{-# LINE 157 "src/Data/Number/Flint/Fmpq/Mat/FFI.hsc" #-}
    <*> (\hsc_ptr -> peekByteOff hsc_ptr 8) ptr
{-# LINE 158 "src/Data/Number/Flint/Fmpq/Mat/FFI.hsc" #-}
    <*> (\hsc_ptr -> peekByteOff hsc_ptr 16) ptr
{-# LINE 159 "src/Data/Number/Flint/Fmpq/Mat/FFI.hsc" #-}
    <*> (\hsc_ptr -> peekByteOff hsc_ptr 24) ptr
{-# LINE 160 "src/Data/Number/Flint/Fmpq/Mat/FFI.hsc" #-}
