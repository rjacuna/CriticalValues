{-# LINE 1 "src/Data/Number/Flint/Fmpz/Mod/MPoly/Factor/FFI.hsc" #-}
{-|
...
instance Storable CFmpzModMPolyFactor where
  {-# INLINE sizeOf #-}
  sizeOf _ = (40)
{-# LINE 61 "src/Data/Number/Flint/Fmpz/Mod/MPoly/Factor/FFI.hsc" #-}
  {-# INLINE alignment #-}
  alignment _ = 8
{-# LINE 63 "src/Data/Number/Flint/Fmpz/Mod/MPoly/Factor/FFI.hsc" #-}
