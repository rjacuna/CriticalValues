{-# LINE 1 "src/Data/Number/Flint/Fq/Zech/Poly/FFI.hsc" #-}
{-|
...
instance Storable CFqZechPoly where
  {-# INLINE sizeOf #-}
  sizeOf _ = (24)
{-# LINE 249 "src/Data/Number/Flint/Fq/Zech/Poly/FFI.hsc" #-}
  {-# INLINE alignment #-}
  alignment _ = 8
{-# LINE 251 "src/Data/Number/Flint/Fq/Zech/Poly/FFI.hsc" #-}
  peek = undefined
  poke = undefined
