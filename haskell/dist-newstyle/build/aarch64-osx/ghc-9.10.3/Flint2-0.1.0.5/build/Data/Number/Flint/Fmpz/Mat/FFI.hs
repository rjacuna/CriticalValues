{-# LINE 1 "src/Data/Number/Flint/Fmpz/Mat/FFI.hsc" #-}
{-|
...
instance Storable CFmpzMat where
  {-# INLINE sizeOf #-}
  sizeOf _ = (32)
{-# LINE 241 "src/Data/Number/Flint/Fmpz/Mat/FFI.hsc" #-}
  {-# INLINE alignment #-}
  alignment _ = 8
{-# LINE 243 "src/Data/Number/Flint/Fmpz/Mat/FFI.hsc" #-}
  peek ptr = CFmpzMat
    <$> (\hsc_ptr -> peekByteOff hsc_ptr 0) ptr
{-# LINE 245 "src/Data/Number/Flint/Fmpz/Mat/FFI.hsc" #-}
    <*> (\hsc_ptr -> peekByteOff hsc_ptr 8) ptr
{-# LINE 246 "src/Data/Number/Flint/Fmpz/Mat/FFI.hsc" #-}
    <*> (\hsc_ptr -> peekByteOff hsc_ptr 16) ptr
{-# LINE 247 "src/Data/Number/Flint/Fmpz/Mat/FFI.hsc" #-}
    <*> (\hsc_ptr -> peekByteOff hsc_ptr 24) ptr
{-# LINE 248 "src/Data/Number/Flint/Fmpz/Mat/FFI.hsc" #-}
