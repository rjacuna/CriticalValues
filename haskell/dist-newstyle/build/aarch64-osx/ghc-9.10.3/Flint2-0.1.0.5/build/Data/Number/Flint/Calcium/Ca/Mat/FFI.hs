{-# LINE 1 "src/Data/Number/Flint/Calcium/Ca/Mat/FFI.hsc" #-}
...
instance Storable CCaMat where
  {-# INLINE sizeOf #-}
  sizeOf _ = (32)
{-# LINE 156 "src/Data/Number/Flint/Calcium/Ca/Mat/FFI.hsc" #-}
  {-# INLINE alignment #-}
  alignment _ = 8
{-# LINE 158 "src/Data/Number/Flint/Calcium/Ca/Mat/FFI.hsc" #-}
  peek ptr = CCaMat
    <$> (\hsc_ptr -> peekByteOff hsc_ptr 0) ptr
{-# LINE 160 "src/Data/Number/Flint/Calcium/Ca/Mat/FFI.hsc" #-}
    <*> (\hsc_ptr -> peekByteOff hsc_ptr 8) ptr
{-# LINE 161 "src/Data/Number/Flint/Calcium/Ca/Mat/FFI.hsc" #-}
    <*> (\hsc_ptr -> peekByteOff hsc_ptr 16) ptr
{-# LINE 162 "src/Data/Number/Flint/Calcium/Ca/Mat/FFI.hsc" #-}
    <*> (\hsc_ptr -> peekByteOff hsc_ptr 24) ptr
{-# LINE 163 "src/Data/Number/Flint/Calcium/Ca/Mat/FFI.hsc" #-}
