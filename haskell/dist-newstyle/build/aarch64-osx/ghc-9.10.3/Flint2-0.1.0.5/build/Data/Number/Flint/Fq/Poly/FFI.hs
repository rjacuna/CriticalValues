{-# LINE 1 "src/Data/Number/Flint/Fq/Poly/FFI.hsc" #-}
{-|
...
instance Storable CFqPoly where
  {-# INLINE sizeOf #-}
  sizeOf _ = (24)
{-# LINE 269 "src/Data/Number/Flint/Fq/Poly/FFI.hsc" #-}
  {-# INLINE alignment #-}
  alignment _ = 8
{-# LINE 271 "src/Data/Number/Flint/Fq/Poly/FFI.hsc" #-}
  peek ptr = CFqPoly
    <$> (\hsc_ptr -> peekByteOff hsc_ptr 0) ptr
{-# LINE 273 "src/Data/Number/Flint/Fq/Poly/FFI.hsc" #-}
    <*> (\hsc_ptr -> peekByteOff hsc_ptr 8) ptr
{-# LINE 274 "src/Data/Number/Flint/Fq/Poly/FFI.hsc" #-}
    <*> (\hsc_ptr -> peekByteOff hsc_ptr 16) ptr
{-# LINE 275 "src/Data/Number/Flint/Fq/Poly/FFI.hsc" #-}
  poke = undefined
