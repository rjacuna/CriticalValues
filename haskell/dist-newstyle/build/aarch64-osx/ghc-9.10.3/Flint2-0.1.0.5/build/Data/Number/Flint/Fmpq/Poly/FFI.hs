{-# LINE 1 "src/Data/Number/Flint/Fmpq/Poly/FFI.hsc" #-}
{-|
...
instance Storable CFmpqPoly where
  {-# INLINE sizeOf #-}
  sizeOf _ = (32)
{-# LINE 320 "src/Data/Number/Flint/Fmpq/Poly/FFI.hsc" #-}
  {-# INLINE alignment #-}
  alignment _ = 8
{-# LINE 322 "src/Data/Number/Flint/Fmpq/Poly/FFI.hsc" #-}
  peek ptr = CFmpqPoly 
    <$> (\hsc_ptr -> peekByteOff hsc_ptr 0) ptr
{-# LINE 324 "src/Data/Number/Flint/Fmpq/Poly/FFI.hsc" #-}
    <*> (\hsc_ptr -> peekByteOff hsc_ptr 24) ptr
{-# LINE 325 "src/Data/Number/Flint/Fmpq/Poly/FFI.hsc" #-}
    <*> (\hsc_ptr -> peekByteOff hsc_ptr 8) ptr
{-# LINE 326 "src/Data/Number/Flint/Fmpq/Poly/FFI.hsc" #-}
    <*> (\hsc_ptr -> peekByteOff hsc_ptr 16) ptr
{-# LINE 327 "src/Data/Number/Flint/Fmpq/Poly/FFI.hsc" #-}
