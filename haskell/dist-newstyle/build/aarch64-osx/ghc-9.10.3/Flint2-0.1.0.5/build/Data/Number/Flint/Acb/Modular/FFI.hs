{-# LINE 1 "src/Data/Number/Flint/Acb/Modular/FFI.hsc" #-}
{-|
...
instance Storable CPSL2Z where
  {-# INLINE sizeOf #-}
  sizeOf _ = (32)
{-# LINE 123 "src/Data/Number/Flint/Acb/Modular/FFI.hsc" #-}
  {-# INLINE alignment #-}
  alignment _ = 8
{-# LINE 125 "src/Data/Number/Flint/Acb/Modular/FFI.hsc" #-}
  peek ptr = CPSL2Z
    <$> (return $ castPtr ptr)
...
instance Storable CPSL2ZWord where
  {-# INLINE sizeOf #-}
  sizeOf _ = (16)
{-# LINE 289 "src/Data/Number/Flint/Acb/Modular/FFI.hsc" #-}
  {-# INLINE alignment #-}
  alignment _ = 8
{-# LINE 291 "src/Data/Number/Flint/Acb/Modular/FFI.hsc" #-}
  peek ptr = CPSL2ZWord
    <$> (\hsc_ptr -> peekByteOff hsc_ptr 0) ptr
{-# LINE 293 "src/Data/Number/Flint/Acb/Modular/FFI.hsc" #-}
    <*> (\hsc_ptr -> peekByteOff hsc_ptr 8) ptr
{-# LINE 294 "src/Data/Number/Flint/Acb/Modular/FFI.hsc" #-}
