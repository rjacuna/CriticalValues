{-# LINE 1 "src/Data/Number/Flint/MPoly/FFI.hsc" #-}
{-|
...
instance Storable CMPolyCtx where
  {-# INLINE sizeOf #-}
  sizeOf _ = (608)
{-# LINE 106 "src/Data/Number/Flint/MPoly/FFI.hsc" #-}
  {-# INLINE alignment #-}
  alignment _ = 8
{-# LINE 108 "src/Data/Number/Flint/MPoly/FFI.hsc" #-}
...
ord_lex       = COrdering 0
{-# LINE 138 "src/Data/Number/Flint/MPoly/FFI.hsc" #-}
ord_deglex    = COrdering 1
{-# LINE 139 "src/Data/Number/Flint/MPoly/FFI.hsc" #-}
ord_degrevlex = COrdering 2
{-# LINE 140 "src/Data/Number/Flint/MPoly/FFI.hsc" #-}
