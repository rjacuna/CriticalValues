{-# LINE 1 "src/Data/Number/Flint/Fmpz/Poly/FFI.hsc" #-}
{-|
...
instance Storable CFmpzPoly where
  {-# INLINE sizeOf #-}
  sizeOf _ = (24)
{-# LINE 488 "src/Data/Number/Flint/Fmpz/Poly/FFI.hsc" #-}
  {-# INLINE alignment #-}
  alignment _ = 8
{-# LINE 490 "src/Data/Number/Flint/Fmpz/Poly/FFI.hsc" #-}
  peek ptr = do
    coeffs <- (\hsc_ptr -> peekByteOff hsc_ptr 0) ptr
{-# LINE 492 "src/Data/Number/Flint/Fmpz/Poly/FFI.hsc" #-}
    alloc  <- (\hsc_ptr -> peekByteOff hsc_ptr 8) ptr
{-# LINE 493 "src/Data/Number/Flint/Fmpz/Poly/FFI.hsc" #-}
    length <- (\hsc_ptr -> peekByteOff hsc_ptr 16) ptr
{-# LINE 494 "src/Data/Number/Flint/Fmpz/Poly/FFI.hsc" #-}
