{-# LINE 1 "src/Data/Number/Flint/Fmpz/LLL/FFI.hsc" #-}
{-|
...
{-# LINE 87 "src/Data/Number/Flint/Fmpz/LLL/FFI.hsc" #-}
...
{-# LINE 94 "src/Data/Number/Flint/Fmpz/LLL/FFI.hsc" #-}
...
instance Storable CFmpzLLL where
  {-# INLINE sizeOf #-}
  sizeOf _ = (24)
{-# LINE 108 "src/Data/Number/Flint/Fmpz/LLL/FFI.hsc" #-}
  {-# INLINE alignment #-}
  alignment _ = 8
{-# LINE 110 "src/Data/Number/Flint/Fmpz/LLL/FFI.hsc" #-}
