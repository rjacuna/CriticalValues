{-# LINE 1 "src/Data/Number/Flint/NMod/Poly/FFI.hsc" #-}
{-|
...
instance Storable CNModPolyMultiCRT where
  {-# INLINE sizeOf #-}
  sizeOf _ = (56)
{-# LINE 415 "src/Data/Number/Flint/NMod/Poly/FFI.hsc" #-}
  {-# INLINE alignment #-}
  alignment _ = 8
{-# LINE 417 "src/Data/Number/Flint/NMod/Poly/FFI.hsc" #-}
  peek = undefined
  poke = undefined
...
instance Storable CNModBerlekampMassey where
  {-# INLINE sizeOf #-}
  sizeOf _ = (344)
{-# LINE 428 "src/Data/Number/Flint/NMod/Poly/FFI.hsc" #-}
  {-# INLINE alignment #-}
  alignment _ = 8
{-# LINE 430 "src/Data/Number/Flint/NMod/Poly/FFI.hsc" #-}
  peek = undefined
  poke = undefined
