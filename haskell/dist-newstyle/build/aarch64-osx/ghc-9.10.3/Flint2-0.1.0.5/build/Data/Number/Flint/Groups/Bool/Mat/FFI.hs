...
instance Storable CBoolMat where
  {-# INLINE sizeOf #-}
  sizeOf _ = (32)
{-# LINE 106 "src/Data/Number/Flint/Groups/Bool/Mat/FFI.hsc" #-}
  {-# INLINE alignment #-}
  alignment _ = 8
{-# LINE 108 "src/Data/Number/Flint/Groups/Bool/Mat/FFI.hsc" #-}
  peek ptr = CBoolMat
    <$> (\hsc_ptr -> peekByteOff hsc_ptr 0) ptr
{-# LINE 110 "src/Data/Number/Flint/Groups/Bool/Mat/FFI.hsc" #-}
