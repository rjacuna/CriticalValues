{-# LINE 1 "src/Data/Number/Flint/Fq/Zech/Mat/FFI.hsc" #-}
{-|
...
instance Storable CFqZechMat where
  {-# INLINE sizeOf #-}
  sizeOf _ = (32)
{-# LINE 125 "src/Data/Number/Flint/Fq/Zech/Mat/FFI.hsc" #-}
  {-# INLINE alignment #-}
  alignment _ = 8
{-# LINE 127 "src/Data/Number/Flint/Fq/Zech/Mat/FFI.hsc" #-}
  peek ptr = CFqZechMat
    <$> (\hsc_ptr -> peekByteOff hsc_ptr 0) ptr
{-# LINE 129 "src/Data/Number/Flint/Fq/Zech/Mat/FFI.hsc" #-}
    <*> (\hsc_ptr -> peekByteOff hsc_ptr 8) ptr
{-# LINE 130 "src/Data/Number/Flint/Fq/Zech/Mat/FFI.hsc" #-}
    <*> (\hsc_ptr -> peekByteOff hsc_ptr 16) ptr
{-# LINE 131 "src/Data/Number/Flint/Fq/Zech/Mat/FFI.hsc" #-}
    <*> (\hsc_ptr -> peekByteOff hsc_ptr 24) ptr
{-# LINE 132 "src/Data/Number/Flint/Fq/Zech/Mat/FFI.hsc" #-}
  poke = undefined
