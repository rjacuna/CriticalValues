{-# LINE 1 "src/Data/Number/Flint/Fmpz/Mod/FFI.hsc" #-}
{-|
...
instance Storable CFmpzModCtx where
  {-# INLINE sizeOf #-}
  sizeOf _ = (112)
{-# LINE 69 "src/Data/Number/Flint/Fmpz/Mod/FFI.hsc" #-}
  {-# INLINE alignment #-}
  alignment _ = 8
{-# LINE 71 "src/Data/Number/Flint/Fmpz/Mod/FFI.hsc" #-}
...
instance Storable CFmpzModDiscreteLogPohligHellmann where
  {-# INLINE sizeOf #-}
  sizeOf _ = (152)
{-# LINE 227 "src/Data/Number/Flint/Fmpz/Mod/FFI.hsc" #-}
  {-# INLINE alignment #-}
  alignment _ = 8
{-# LINE 229 "src/Data/Number/Flint/Fmpz/Mod/FFI.hsc" #-}
